    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Bachelor of Science (Honours): Computer Science,
          <br/>Memorial University of Newfoundland (Sep 2020 - Dec 2024)<br/>- St.John`&epos;`s, NL, Canada</li>
      </ul>
    ),
  },
];
  ...
  return (
    <section className="text-white" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 items-start py-8 px-4 xl:gap-16 sm:py-20 xl:px-20">
        <Image src="/images/about-image.png" width={500} height={500}  className="rounded-full" />
