            ...
            <div className="lg:hidden">
              <div className="grid grid-cols-1 gap-8">
                <div className="border-b-2">
                  ...
                  <div className="p-3 text-red-400 text-sm font-semibold">May 2024 - Current</div>
                  <div className="p-3 text-sm">I am engaged in pioneering work to advance the understanding of atmospheric
                    dynamics through visual
                    computing techniques. My primary responsibility involves constructing global wind data into a 3D
                    holographic environment using Unreal Engine and C++. This project is designed to analyze the impact of
                    varying wind conditions on flight trajectories, offering insights that can improve aviation safety and
                    efficiency.
                  </div>
                </div>
                <div className="border-b-2">
                ...
                <div className="border-b-2">
                  ...
                  <div className="p-3 text-sm">I was responsible for engaging customers, understanding their needs, and
                    ...
                    home appliance solutions. This role involves demonstrating product knowledge, providing expert advice,
                    and
                    closing sales while ensuring a high level of customer satisfaction.
                  </div>
                </div>
